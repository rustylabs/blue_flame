...
Currently you cannot do ANYTHING at all, it just has a blank window with some buttons which does not create shapes as we need to port the renderer over.